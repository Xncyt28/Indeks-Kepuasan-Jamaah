		...
		<div class="relative overflow-x-auto p-5 sm:rounded-lg">
					...
					@else
						@foreach ($respondens as $responden)
							<tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
								...
								<td scope="row" class="px-6 py-4 text-gray-900 dark:text-white">
									{{ $responden->tempat_tinggal }}
								</td>
								<td scope="row" class="px-6 py-4 text-gray-900 dark:text-white">
									{{ $responden->tempat_mendaftar }}
								</td>
								<td scope="row" class="px-6 py-4 text-gray-900 dark:text-white">
									{{ $responden->tanggal_keberangkatan }}
								</td>
								<td scope="row" class="px-6 py-4 text-gray-900 dark:text-white">
									{{ $responden->paket_dilih }}
								</td>
								<td scope="row" class="px-6 py-4 text-gray-900 dark:text-white">
									{{ $responden->nama_tl }}
								</td>
			...
			<div class="mt-5">
				{{ $respondens->onEachSide(1)->appends([
				        ...
				        'tempat_mendaftar' => request('tempat_mendaftar'),
						'tanggal_keberangkatan' => request('tanggal_keberangkatan'),
						'paket_dilih' => request('paket_dilih'),
						'nama_tl' => request('nama_tl'),
						'mutowif' => request('mutowif'),
