	...
	<x-card>
		<div class="relative overflow-x-auto p-5 sm:rounded-lg">
			<dl class="w-full divide-y divide-gray-200 text-gray-900 dark:divide-gray-700 dark:text-white mb-5">
				...
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">tempat_tinggal</dt>
					<dd class="text-lg font-semibold">{{ $responden->tempat_tinggal }}</dd>
				</div>
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">tempat_mendaftar</dt>
					<dd class="text-lg font-semibold">{{ $responden->tempat_mendaftar }}</dd>
				</div>
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">tanggal_keberangkatan</dt>
					<dd class="text-lg font-semibold">{{ $responden->tanggal_keberangkatan }}</dd>
				</div>
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">paket_dilih</dt>
					<dd class="text-lg font-semibold">{{ $responden->paket_dilih }}</dd>
				</div>
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">nama_tl</dt>
					<dd class="text-lg font-semibold">{{ $responden->nama_tl }}</dd>
				</div>
				<div class="flex flex-col py-3">
					<dt class="mb-1 text-gray-500 dark:text-gray-400 md:text-lg">mutowif</dt>
					<dd class="text-lg font-semibold">{{ $responden->mutowif }}</dd>
				</div>
				<div class="flex flex-col py-3">
