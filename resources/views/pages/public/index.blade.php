...
@section('title', 'Index Kepuasan Jamaah Haji dan umrah')
@section('content')
<section class="mb-10 bg-white bg-bottom bg-no-repeat px-5 pb-5 dark:bg-gray-900" style="background-image: url({{ asset('assets/wave.svg') }}); height: calc(100vh - 115px);">
	<div class="mx-auto mt-10 grid h-full max-w-screen-lg rounded-xl border-2 bg-white px-4 py-8 shadow lg:h-auto lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
		<div class="mr-auto md:pl-10 place-self-center text-center lg:col-span-7 lg:place-self-start lg:text-start">
			...
			Survei Kepuasan Jamaah Haji dan Umrah</h1>
...
<section class="mb-10 min-h-screen grid place-content-center px-5">
	<div class="mx-auto max-w-screen-lg">
		<div class="p-8">
			<div class="felx-col flex items-center justify-center"> <span class="rounded-full bg-indigo-500 px-2 py-1 text-sm uppercase text-white"> PT. ZAFA MULIA MANDIRI </span> </div>
			<h1 class="mt-6 text-center text-4xl font-medium text-gray-700"> Index Kepuasan Jamaah Haji dan Umrah </h1>
	...
	<div class="mx-auto max-w-screen-lg px-4 py-8 sm:px-6 lg:px-8">
		<div class="sm:flex sm:items-center sm:justify-between">
			<a href="{{ route('index') }}" class="flex items-center">
				<img src="{{ asset('assets/logozafa.png') }}" class="mr-3 h-8" alt="Logo" />
				<span class="self-center whitespace-nowrap text-2xl font-medium dark:text-white">{{ config('app.name') }}</span>
			</a>
			<p class="mt-4 text-center text-sm text-gray-500 lg:mt-0 lg:text-right">
				Copyright &copy; SNAKU. All rights reserved. | 
				<a href="https://wa.me/6283802940605" target="_blank">Hubungi Kami</a>
			</p>
